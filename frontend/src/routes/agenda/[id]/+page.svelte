...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-8 flex items-center justify-between">
    ...
    <button type="button" on:click={() => window.print()} class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div class="divide-y divide-gray-200">
            {#each agenda.faculty_updates as announcement}
              <div class="border-b border-gray-200">
                <button 
                  class="w-full p-4 text-left hover:bg-gray-50 dark:hover:bg-gray-700 mbp:hover:bg-red-950/20 lsu:hover:bg-purple-950/20 transition-colors"
                ...
                >
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                      ...
                      <div>
                        <h4 class="text-lg font-bold text-gray-900 dark:text-gray-100 mbp:text-gray-100 lsu:text-gray-100">{announcement.user_name || 'Faculty Member'}</h4>
                        <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 mbp:text-gray-300 lsu:text-gray-300">
                ...
                >
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                      ...
                      <div>
                        <h4 class="text-lg font-bold text-gray-900 dark:text-gray-100 mbp:text-gray-100 lsu:text-gray-100">{update.user_name || 'Student'}</h4>
                        <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 mbp:text-gray-300 lsu:text-gray-300">
