...
from app.api.endpoints import text, mock_auth, updates, faculty_updates, meetings, users, roster, presentations

api_router = APIRouter()

# Include individual routers
api_router.include_router(text.router, prefix="/text", tags=["text"])
api_router.include_router(mock_auth.router, prefix="/auth", tags=["auth"])
