...
def check_database():
    ...
    with Session(engine) as session:
        ...
        # Check meetings
        meeting_count = session.execute(text("SELECT COUNT(*) FROM meeting")).scalar()
        ...
        # Check agenda items
        agenda_count = session.execute(text("SELECT COUNT(*) FROM agendaitem")).scalar()
        ...
        reg_count = session.execute(text("SELECT COUNT(*) FROM registrationrequest")).scalar()
        ...
        # Check file uploads
        file_count = session.execute(text("SELECT COUNT(*) FROM fileupload")).scalar()
